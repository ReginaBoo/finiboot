export const BondsTableHeader = () => {
  return (
    <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-gray-50 rounded-t-lg border-b border-gray-100">
      <div className="col-span-2 font-semibold text-gray-600">Название, эмитент</div>
      <div className="col-span-2 font-semibold text-gray-600 text-right">Номинал</div>
      <div className="col-span-2 font-semibold text-gray-600 text-right">Сектор</div>
      <div className="col-span-2 font-semibold text-gray-600 text-right">Кол-во выплат в год</div>
